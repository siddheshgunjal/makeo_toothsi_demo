...
//3D model variables
let model0L = "./assets/simran_lower_1.glb";
let model0U = "./assets/simran_upper_1.glb";

let model1L = "./assets/simran_lower_2.glb";
let model1U = "./assets/simran_upper_2.glb";

let model2L = "./assets/simran_lower_3.glb";
let model2U = "./assets/simran_upper_3.glb";

let model3L = "./assets/simran_lower_4.glb";
let model3U = "./assets/simran_upper_4.glb";

let model4L = "./assets/simran_lower_5.glb";
let model4U = "./assets/simran_upper_5.glb";

let model5L = "./assets/simran_lower_6.glb";
let model5U = "./assets/simran_upper_5.glb";

let model6L = "./assets/simran_lower_7.glb";
let model6U = "./assets/simran_upper_7.glb";

let model7L = "./assets/simran_lower_8.glb";
let model7U = "./assets/simran_upper_8.glb";

let model8L = "./assets/simran_lower_9.glb";
let model8U = "./assets/simran_upper_9.glb";

let model9L = "./assets/simran_lower_10.glb";
let model9U = "./assets/simran_upper_10.glb";

let model10L = "./assets/simran_lower_11.glb";
let model10U = "./assets/simran_upper_11.glb";
